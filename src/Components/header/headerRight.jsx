...
const HeaderRight = () => {
    return (
        <div className="flex items-center pt-6 sm:mt-0 sm:mr-6 md:mr-0 lg:flex">
            ...
            <ul className="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
                <li className="flex items-center">
                    <Link href='/signIn' className="flex px-0 py-2 font-semibold transition-all ease-nav-brand text-sm text-slate-500">
                ...
                <li className="flex items-center px-4">
                    ...
                    <Link href='/biling' className="p-0 transition-all text-sm ease-nav-brand text-slate-500">
                ...
                <li className="relative flex items-center pr-2">
                    ...
                    <Link href='/tables' className="block p-0 transition-all text-sm ease-nav-brand text-slate-500">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 cursor-pointer">
                    ...
                    <ul className="text-sm transform-dropdown before:font-awesome before:leading-default before:duration-300 before:ease-in lg:shadow-2xl duration-250 min-w-44 before:sm:right-7 pointer-events-none absolute right-0 top-0 z-50 origin-top list-none rounded-lg border-0 border-solid border-transparent bg-white bg-clip-padding px-2 py-4 text-left text-slate-500 opacity-0 transition-all before:absolute before:right-2 before:left-auto before:top-0 before:z-50 before:inline-block before:font-normal before:text-white before:antialiased before:transition-all before:content-['\f0d8'] sm:-mr-6 lg:absolute lg:right-0 lg:left-auto lg:mt-2 lg:block lg:cursor-pointer">
                    </ul>
                </li>
            </ul>
        </div>
